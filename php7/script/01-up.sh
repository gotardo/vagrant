...
alias project_test=\"clear &&  mysql -u root -p123456 < db/db.sql && php bin/console cache:clear && phpunit --coverage-text --verbose --colors --coverage-html ./report\"
...
sudo mkdir -p /var/sessions/dev
sudo chmod 0777 /var/sessions/dev
